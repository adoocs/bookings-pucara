...
public class DlgProductoConsultar extends javax.swing.JDialog {

    DefaultTableModel modelo = new DefaultTableModel();
    private static DlgProductoConsultar INSTANCE;
    public Producto producto = null;
    
    public static synchronized DlgProductoConsultar getInstance() {
        if (INSTANCE == null)
            INSTANCE = new DlgProductoConsultar();
        return INSTANCE;
    }
    
    private DlgProductoConsultar() {
    ...
    private void initComponents() {
        ...
        txtCodigProducto = new javax.swing.JTextField();
        ...
        txtCodigProducto.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtCodigProducto.setForeground(new java.awt.Color(255, 255, 255));
        txtCodigProducto.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(255, 255, 255), new java.awt.Color(0, 0, 153), null, new java.awt.Color(0, 0, 153)), "CÓDIGO DE PRODUCTO"));
        txtCodigProducto.setSelectionColor(new java.awt.Color(204, 0, 204));
        txtCodigProducto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtCodigProductoKeyTyped(evt);
            }
        });
        jPanel2.add(txtCodigProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 20, 200, 40));
        ...
        jPanel2.add(chkAuto, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 30, 70, 30));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 32, 810, 70));

        jTable1.setModel(modelo);
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 112, 507, 290));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 182, 170, -1));
    ...
    private void txtCodigProductoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigProductoKeyTyped
        if (chkAuto.isSelected()) {
            String id = txtCodigProducto.getText().trim();
            ProductoDAO.getInstance().eventMostrar(id,modelo);
        }
    }//GEN-LAST:event_txtCodigProductoKeyTyped
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if (x != -1) {
            ...
            producto = ProductoDAO.getInstance().buscar(id);
            dispose();
        } else
    ...
    private javax.swing.JTextField txtCodigProducto;
