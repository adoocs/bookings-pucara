...
public class DlgHabitacionConsultar extends javax.swing.JDialog {

    DefaultTableModel modelo = new DefaultTableModel();
    private static DlgHabitacionConsultar INSTANCE;
    public Habitacion habitacion;
    
    public static synchronized DlgHabitacionConsultar getInstance() {
        if (INSTANCE == null)
            INSTANCE = new DlgHabitacionConsultar();
        return INSTANCE;
    }
    public DlgHabitacionConsultar() {
    ...
    private void initComponents() {
        ...
        txtCodigoHabitacion.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtCodigoHabitacion.setForeground(new java.awt.Color(255, 255, 255));
        txtCodigoHabitacion.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(255, 255, 255), new java.awt.Color(0, 0, 153), null, new java.awt.Color(0, 0, 153)), "CÓDIGO DE HABITACIÓN"));
        txtCodigoHabitacion.setSelectionColor(new java.awt.Color(204, 0, 204));
        txtCodigoHabitacion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtCodigoHabitacionKeyTyped(evt);
            }
        });
        jPanel2.add(txtCodigoHabitacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 20, 200, 40));
        ...
        jPanel2.add(chkAuto, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 30, 70, 30));
    ...
    private void txtCodigoHabitacionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoHabitacionKeyTyped
        if (chkAuto.isSelected()) {
            String id = txtCodigoHabitacion.getText().trim();
            HabitacionDAO.getInstance().eventMostrar(id,modelo);
        }
    }//GEN-LAST:event_txtCodigoHabitacionKeyTyped
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if (x != -1) {
            ...
            habitacion = HabitacionDAO.getInstance().buscar(id);
            dispose();
        } else
