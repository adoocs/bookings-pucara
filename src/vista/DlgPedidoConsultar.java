 ...
 * @author ACER
 */
public class DlgPedidoConsultar extends javax.swing.JDialog {

    DefaultTableModel modelo=new DefaultTableModel();
    private static DlgPedidoConsultar INSTANCE;
    public Pedido pedido = null;
    
    public static synchronized DlgPedidoConsultar getInstance() {
        if (INSTANCE == null)
            INSTANCE = new DlgPedidoConsultar();
        return INSTANCE;
    }
    private DlgPedidoConsultar() {
    ...
    private void initComponents() {
        ...
        txtIdPedido.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(255, 255, 255), new java.awt.Color(0, 0, 153), null, new java.awt.Color(0, 0, 153)), "ID PEDIDO"));
        txtIdPedido.setSelectionColor(new java.awt.Color(204, 0, 204));
        txtIdPedido.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtIdPedidoKeyTyped(evt);
            }
        });
        jPanel2.add(txtIdPedido, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 20, 200, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 112, 500, 290));
        ...
        getContentPane().add(fondo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, -180, 840, 610));
    ...
    private void txtIdPedidoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdPedidoKeyTyped
        if (chkAuto.isSelected()) {
            ...
            PedidoDAO.getInstance().eventMostrar(id,modelo);
        }
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if (x != -1) {
            ...
            pedido = PedidoDAO.getInstance().buscar(id);
            dispose();
        } else
